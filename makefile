...
server:NTP_server_main.cpp NTP_server_function.o myservertime.o
	g++ -o server NTP_server_main.cpp NTP_server_function.o myservertime.o	
NTP_server_function.o:NTP_server_function.cpp NTP_server_header.h
	g++ -c NTP_server_function.cpp
myservertime.o:myservertime.cpp NTP_server_header.h
	g++ -c myservertime.cpp
